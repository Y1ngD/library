...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from rukujilu where jingshouren='".$_SESSION['username']."'";
...
//youzuiping2
  ...
  <tr>
	...
	<a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=rukujilu" onclick="return confirm('真的要删除？')">删除</a> <a href="rukujilu_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a>
	 <a href="rukujilu_detail.php?id=<?php echo mysql_result($query,$i,"id");?>">详细</a></td>
  </tr>
  	<?php
	}
}
