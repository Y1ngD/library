...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from shangpinxinxi where faburen='".$_SESSION['username']."'";
...
//youzuiping2
  ...
  <tr>
	...
	<?php if(mysql_result($query,$i,issh)=="否"){?><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=shangpinxinxi" onclick="return confirm('真的要删除？')">删除</a> <a href="shangpinxinxi_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a><?php } ?>
	 <a href="shangpinxinxidetail.php?id=<?php echo mysql_result($query,$i,"id");?>" target="_blank">详细</a></td>
  </tr>
  	<?php
	}
}
...
<p>以上数据共<?php echo $rowscount;?>条,共计总库存:<?php echo $kucunz?>；销量:<?php echo $xiaoliangz?>； <!--youzuiping3-->
