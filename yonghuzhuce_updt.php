...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
	  ...
	  <tr><td>地址：</td><td><input name='diqu' type='text' id='diqu' value='<?php echo mysql_result($query,$i,diqu);?>' size="50" /></td></tr><tr><td>电话：</td>
	    <td><input name='Email' type='text' id='Email' value='<?php echo mysql_result($query,$i,Email);?>' /></td>
	  </tr><tr><td>照片：</td><td><input name='zhaopian' type='text' id='zhaopian' size='50' value='<?php echo mysql_result($query,$i,zhaopian);?>' />
