...
for($i=0;$i<$rowscount;$i++)
{
	...
	<div style class="ui-tabs-panel ui-tabs-hide" id="fragment-<?php echo $i+1;?>">
		...
		<div class="info">
			<h2><a class="STYLE3"  href="gg_detail.php?id=<?php echo mysql_result($query,$i,0)?>"><?php echo mysql_result($query,$i,1)?></a> <a href="gg_detail.php?id=<?php echo mysql_result($query,$i,0)?>">[璇��]</a></p>
		</div>
	</div>
	<?php
		}
