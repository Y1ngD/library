...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>订单号</td><td bgcolor='#CCFFFF'>金额</td><td bgcolor='#CCFFFF'>订单内容</td><td bgcolor='#CCFFFF'>用户名</td><td bgcolor='#CCFFFF'>姓名</td><td bgcolor='#CCFFFF'>邮寄地址</td><td bgcolor='#CCFFFF'>电话</td><td bgcolor='#CCFFFF'>快递类型</td><td bgcolor='#CCFFFF'>快递费用</td>
...
<input type=button name=Submit53 value=评论 onClick="javascript:OpenScript('hsgpinglun.php?biao=dingdan&id=<?php echo $id;?>',500,200)" style='border:solid 1px #000000; color:#666666; width:50px;'  />	<?php }
