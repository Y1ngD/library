...
<form id="form1" name="form1" method="post" action="">
  ...
  日期：
  <input name="riqi1" type="text" id="riqi1"  value='' onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})"  style='border:solid 1px #000000; color:#666666; width:80px;' />
  -
  <input name="riqi2" type="text" id="riqi2"  value='' onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})"  style='border:solid 1px #000000; color:#666666; width:80px;' />
...
if ($_POST["riqi1"]!=""){$nreqriqi1=$_POST["riqi1"];$sql=$sql." and addtime >= '$nreqriqi1'";}
if ($_POST["riqi2"]!=""){$nreqriqi2=$_POST["riqi2"];$sql=$sql." and addtime <= '$nreqriqi2'";}
...
//youzuiping2
  ...
  <tr>
    ...
    <td width="120" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=goumaijilu" onclick="return confirm('真的要删除？')">删除</a> <a href="goumaijilu_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a> <!--qiatnalijne--> </td>
  </tr>
  	<?php
	}
}
