                  ...
                  <tr>
                    <td><table id="__01" width="1025" height="353" border="0" cellpadding="0" cellspacing="0">
                      <tr>
						...
						<form id="form1" name="form1" method="post" action="shangpinxinxilist.php">
...
<table width="98%" border="0"  align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse" class="newsline">  
  <tr>
    ...
    <td bgcolor='#CCFFFF'>图书编号</td><td bgcolor='#CCFFFF'>图书名称</td><td bgcolor='#CCFFFF'>图书类别</td><td bgcolor='#CCFFFF'>主图</td><td bgcolor='#CCFFFF'>价格</td><td bgcolor='#CCFFFF'>销量</td>
    
    <td width="30" align="center" bgcolor="#CCFFFF">操作</td>
  </tr>
  <?php 
    $sql="select * from shangpinxinxi where  shangpinleibie='$lb'";
...
if ($_POST["shangpinleibie"]!=""){$nreqshangpinleibie=$_POST["shangpinleibie"];$sql=$sql." and shangpinleibie like '%$nreqshangpinleibie%'";}
  $sql=$sql." order by xiaoliang desc,id desc";
...
<p align="center"><a href="shangpinxinxilist.php?pagecurrent=1"><span class="STYLE9">首页</span></a>, <a href="shangpinxinxilist.php?pagecurrent=<?php echo $pagecurrent-1;?>"><span class="STYLE9">前一页</span></a> ,<a href="shangpinxinxilist.php?pagecurrent=<?php echo $pagecurrent+1;?>"><span class="STYLE9">后一页</span></a>, <a href="shangpinxinxilist.php?pagecurrent=<?php echo $pagecount;?>"><span class="STYLE9">末页</span></a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
